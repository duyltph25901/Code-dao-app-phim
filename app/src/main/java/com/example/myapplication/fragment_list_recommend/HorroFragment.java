 ...
 * Use the {@link HorroFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class HorroFragment extends Fragment {
     ...
     * @return A new instance of fragment HorroFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static HorroFragment newInstance(String param1, String param2) {
        HorroFragment fragment = new HorroFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_horro, container, false);
    ...
    private void init(View view) {
        rcv = view.findViewById(R.id.rcvHorrorFilm);
        films = new ArrayList<>();
    ...
    private List<Film> getFilms() {
        ...
        films = FilmDatabase.getInstance(getActivity()).filmDAO().searchFilmByCategory("Horror Movies");
