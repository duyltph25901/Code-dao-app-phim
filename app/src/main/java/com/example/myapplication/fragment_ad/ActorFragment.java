...
public class ActorFragment extends Fragment {
    ...
    private void init(View view) {
        inputFullName = view.findViewById(R.id.inputFullNameActor);
        inputStory = view.findViewById(R.id.inputStoryActor);
        txtDOB = view.findViewById(R.id.txtDOBActor);
        avt = view.findViewById(R.id.imgActor);
        spnCountries = view.findViewById(R.id.spnCountriesActor);
        spnSex = view.findViewById(R.id.spnSexActor);
        btnClear = view.findViewById(R.id.btnClearActor);
        btnChooseImage = view.findViewById(R.id.btnChooseImageActor);
        btnAdd = view.findViewById(R.id.btnAddActor);
...
//                    + ", Country Name = " + obj.getDisplayCountry());
    ...
    private void add() {
        ...
        Actor actor = new Actor(DataConvert.imagemTratada(DataConvert.convertImageToByArr(bitmap)), fullName, dob, countries, gender, story);
        ActorDatabase.getInstance(getActivity()).actorDAO().insert(actor);
        clear();
        displayKeyboard();
